...
<body>
    ...
    <div class="admin-crud-kontejner">
        <div class="admin-dodaj-proizvod">
            <form action="admin_crud.php?akcija=dodaj-proizvod" method="post">
                ...
                <div class="admin">
                    ...
                    <?php $sezone = range(2010, strftime("%Y", time())); ?>
                    <select name="sezona" id="">
        ...
        <div class="admin-izmeni-proizvod">
            <form action="admin_crud.php?akcija=izmeni-proizvod" method="post">
                <div class="admin-n">IZMENI PROIZVOD</div>
                <div class="admin">
                    <label for="">ID PROIZVODA: </label>
                    <?php
                        require_once("funkcije/podaci/baza_ucitavanje.php");
                        echo "<select name='id_proizvoda' id=''>";
